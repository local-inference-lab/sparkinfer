...
from b12x.moe.fused.static_common import MoEStaticKernelBase
...
class MoEStaticKernel(MoEStaticKernelBase):
    ...
    def __call__(
        ...
        # FC1 scale-factor tensor. Gated activation packs [up, gate] along N.
        ...
        # [up, gate] along N; relu2 keeps a single FC1 pass.
