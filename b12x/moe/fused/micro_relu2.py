"""
MoEMicroKernelRelu2 — micro-scheduled routed NVFP4 MoE kernel for SM120 (Blackwell).

ReLU2 (non-gated) variant of MoEMicroKernel.  Forked because CuTe DSL
