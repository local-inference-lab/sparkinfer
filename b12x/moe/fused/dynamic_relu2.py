"""
MoEDynamicKernelRelu2 — queue-driven routed NVFP4 MoE kernel for SM120.

ReLU2 (non-gated) variant of MoEDynamicKernel.  Forked because CuTe DSL
cannot handle conditional control flow in kernel code.

This is the first dynamic fused control-plane kernel derived from the current
static implementation. It keeps the proven FC1 / ReLU2 / quant / FC2 / scatter
...
Execution model
  ...
  Phase 2: CTAs that finish producing become consumers immediately
           ...
           - MMA warps run FC1 -> ReLU2 -> quant -> FC2 -> scatter for that task
        ...
        while consumer_live > Int32(0):
            ...
            if has_task == Int32(0):
                ...
                while slice_idx < task_slice_count_val:
                    ...
                    tBgB_w13_nk = tBgB_w13[(None, intermediate_slice, None, task_expert_idx)]
                    tBgSFB_w13_nk = tBgSFB_w13[(None, intermediate_slice, None, task_expert_idx)]
