...
class MoEDynamicKernel:
    ...
    def kernel(
        ...
        if cutlass.const_expr(self.is_gated):
            ...
            up_prod_state = prod_state
            up_cons_state = cons_state
        ...
        while consumer_live > Int32(0):
            ...
            if has_task == Int32(0):
                ...
                while slice_idx < task_slice_count_val:
                    ...
                    # the gate staging buffers, either for the up pass or FC2
                    # prefetch.
                ...
                while slice_idx < task_slice_count_val:
                    ...
                    if cutlass.const_expr(self.is_gated):
                        ...
                        tBgB_w13_gate_nk = tBgB_w13[(None, intermediate_slice, None, task_expert_idx)]
                        tBgSFB_w13_gate_nk = tBgSFB_w13[(None, intermediate_slice, None, task_expert_idx)]
