...
from sparkinfer.gemm.qbmm_absorb._kernel import (
...
def test_dequant_bitwise_vs_torch_reference(pack) -> None:
    ...
    for p0 in range(0, P, 32):
        ...
        torch.ops.sparkinfer.qbmm_absorb_ukt(a, values, scales, out)
        want = torch.stack(
...
def test_envelope_vs_cublas(pack, batch: int) -> None:
    ...
    torch.ops.sparkinfer.qbmm_absorb_ukt(a1, values, scales, o1)
    ...
    torch.ops.sparkinfer.qbmm_absorb_uv(a2, values, scales, o2.transpose(0, 1))
...
def test_replay_determinism(pack) -> None:
    ...
    torch.ops.sparkinfer.qbmm_absorb_ukt(a, values, scales, o1)
    torch.ops.sparkinfer.qbmm_absorb_ukt(a, values, scales, o2)
...
def test_cudagraph_capture_replay(pack) -> None:
    ...
    torch.ops.sparkinfer.qbmm_absorb_ukt(fresh, values, scales, eager)
