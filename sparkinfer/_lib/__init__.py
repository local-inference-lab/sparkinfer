"""Shared runtime for sparkinfer (vendored from sparkinfer).
...
sparkinfer's ``from sparkinfer.cute import compile, launch, ...`` idiom — which is when
...
# match sparkinfer's `from .intrinsics import *; from .utils import *` aggregation.
