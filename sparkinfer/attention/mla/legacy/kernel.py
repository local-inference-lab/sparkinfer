...
def _compute_score_tile_scaled(
    ...
    for group_idx in cutlass.range_constexpr(_MLA_SCALE_GROUPS):
        ...
        if cutlass.const_expr(os.environ.get("SPARKINFER_MLA_DEBUG_QK_BF16", "0") == "1"):
...
def _run_staged_pv_group_into_target(
    ...
    if cutlass.const_expr(
        os.environ.get("SPARKINFER_MLA_ENABLE_MXFP8_PV", "0") != "1"
        or os.environ.get("SPARKINFER_MLA_DEBUG_PV_BF16", "0") == "1"
    ):
