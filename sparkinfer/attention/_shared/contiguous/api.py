...
class AttentionBinding:
    ...
    def run(self) -> tuple[torch.Tensor, torch.Tensor]:
        return sparkinfer_attention_forward(binding=self)
...
class VarlenAttentionBinding:
    ...
    def run(self) -> tuple[torch.Tensor, torch.Tensor]:
        return sparkinfer_varlen_attention_forward(binding=self)
    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "sparkinfer attention launch is unsupported with "
    ...
    def __init__(
        ...
        *,
        ...
        if not ContiguousAttentionForwardKernel.can_implement(
            ...
            raise TypeError(
                "sparkinfer varlen attention launch is unsupported with "
                f"dtype={dtype}, q_shape={q_shape}, k_shape={k_shape}, v_shape={v_shape}, "
...
def allocate_attention_workspace(
    ...
    *,
    ...
    """Allocate one exact-shape workspace for `sparkinfer_attention_forward`."""
...
def allocate_varlen_attention_workspace(
    ...
    *,
    ...
    """Allocate one exact-shape workspace for `sparkinfer_varlen_attention_forward`."""
...
def sparkinfer_attention_forward(
    ...
    *,
    ...
    if binding is not None:
        ...
        raise TypeError("sparkinfer_attention_forward requires binding")
...
def sparkinfer_varlen_attention_forward(
    q: torch.Tensor | None = None,
    k: torch.Tensor | None = None,
    v: torch.Tensor | None = None,
